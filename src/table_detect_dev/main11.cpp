...
void go(int offset, int k)
{
  ...
  if ( k == 0)
  {
    ...
    if (((dist1 > table_dim[0]-10) && (dist1 < table_dim[0]+10)) ||  ((dist2 > table_dim[0]-10) && (dist2 < table_dim[0]+10))   ||  ((dist3 > table_dim[0]-10) && (dist3 < table_dim[0]+10)))
    {
      check[0] = 1;
      ROS_INFO("check1!");
    }
    if (((dist1 > table_dim[1]-10) && (dist1 < table_dim[1]+10)) ||  ((dist2 > table_dim[1]-10) && (dist2 < table_dim[1]+10))   ||  ((dist3 > table_dim[1]-10) && (dist3 < table_dim[1]+10)))
    {
      check[1] = 1;
      ROS_INFO("check2!");
    }
    if (((dist1 > table_dim[2]-10) && (dist1 < table_dim[2]+10)) ||  ((dist2 > table_dim[2]-10) && (dist2 < table_dim[2]+10))   ||  ((dist3 > table_dim[2]-10) && (dist3 < table_dim[2]+10)))
    {
      check[2] = 1;
      ROS_INFO("check3!");
    }
    if (check[0] == check [1] == check[2] == 1)
    {
      ...
      if ((dist1 > table_dim[2]-10) && (dist1 < table_dim[2]+10))
      {
      ...
      else if ((dist2 > table_dim[2]-10) && (dist2 < table_dim[2]+10))
      {
      ...
      if ((dist1 > table_dim[1]-10) && (dist1 < table_dim[1]+10))
      {
        p.x = x[0] / 100;
        p.y = y[0] / 100;
        p.z = 0.0;
      ...
      else if ((dist2 > table_dim[1]-10) && (dist2 < table_dim[1]+10))
      {
        p.x = x[2] / 100;
        p.y = y[2] / 100;
        p.z = 0.0;
